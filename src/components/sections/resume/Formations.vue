<template>
  <div>
    ...
    <v-card
      ...
      :key="index"
      class="pa-7 pa-md-12 my-10 my-md-12 custom-hover"
      elevation="0"
      rounded="xl"
    >
      <v-row >
        ...
        <v-col>
          <span class="font-weight-bold color-hover py-0 text-h6">
            {{ item.date }}
          </span>
          <v-card-title class="text-h6 text-md-h5 pl-0 pt-1 font-weight-bold color-hover">
            {{ item.title }}
          </v-card-title>
          <v-card-subtitle class="color-hover pl-0">
            {{ item.place }}
          </v-card-subtitle>
        </v-col>
      </v-row>
...
.custom-hover:hover .color-hover {
    color: white;
}
.custom-hover:hover .custom-icon-wrap{
    background-color: #f9f9ff;
}
.custom-icon-wrap {
    border-radius: 50%;
